                ...
                <div class="relative inline-block text-left">
                    <div>
                      ...
                      on:click={() => dropdownOpen = !dropdownOpen}
                       type="button" class="inline-flex w-full justify-center gap-x-1.5 rounded-md  px-2 py-1 text-sm font-semibold text-gray-900  " id="menu-button" aria-expanded="true" aria-haspopup="true">
