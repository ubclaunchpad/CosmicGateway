...
<div class="h-full overflow-scroll flex w-full dark:bg-neutral-900" id="main-page">
	...
	{#if $sidePanel && $sidePanel.component}
		<div
			class={`flex flex-col gap-6 ${$sidePanel.open ? 'w-96' : 'w-10'} bg-white dark:bg-neutral-900 rounded-l-sm p-5 relative slider
