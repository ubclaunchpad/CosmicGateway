...
<!--								&lt;!&ndash; {#each Object.entries(FACULTIES_V2) as [facultyId, facultyName]}-->
...
<!--								&lt;!&ndash; {#each Object.entries(PROGRAMS_V2) as [programId, programName]}-->
...
<!--								&lt;!&ndash; {#each Object.entries(STANDINGS_V2) as [standingId, standingName]}-->
